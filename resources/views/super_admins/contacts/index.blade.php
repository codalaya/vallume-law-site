        ...
        <div class="container-fluid">
            <div class="row align-items-center mb-4 pt-4 pt-lg-0">
                ...
                <div class="col-md-7 mb-3 mb-lg-0">
                    <h2 class="main-content-title fw-bold mb-0">Contacts</h2>
                ...
                <div class="col-md-5">
                    <div class="d-flex justify-content-start justify-content-md-end">
                        ...
                        @endphp
                        @if (auth()->user()->hasPermission('contact.export'))
                        ...
                        @endif
                        @if (auth()->user()->hasPermission('contact.import'))
                        ...
                        @endif
                        @if (auth()->user()->hasPermission('contact.add'))
                            <a href="{{ route('super_admin.contacts.create') }}" class="btn btn-primary  ml-2">
                                <i class="fa fa-plus-circle" aria-hidden="true"></i><span class="ml-2">Add contact</span>
                            </a>
                        @endif
