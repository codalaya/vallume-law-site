            ...
            <div class="row mb-4 pt-4 pt-lg-0">
                ...
                <div class="col-sm-6">
                    ...
                    <ol class="breadcrumb float-sm-left">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('super_admin.podcasts.index') }}">Podcast</a></li>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-secondary">
                        ...
                        <!-- form start -->
                        <form id="quickForm" method="POST" action="{{ route('super_admin.podcasts.store') }}"
                                    ...
                                    <div class="col-md-12 col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <select aria-describedby="PodcastCategoryError" aria-invalid="true"
                                                ...
                                                class="form-control curr-sym @if ($errors->has('podcast_category_id')) is-invalid @endif"
                                                ...
                                                @if (count($podcast_categories) > 0)
                                                    ...
                                                    @foreach ($podcast_categories as $podcast_category)
                                                        <option value="{{ $podcast_category->id }}"
                                                            {{ old('podcast_category_id') == $podcast_category->id ? 'selected' : '' }}>
