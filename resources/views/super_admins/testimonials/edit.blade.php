            ...
            <div class="row  mb-4 pt-4 pt-lg-0">
                ...
                <div class="col-sm-6">
                    ...
                    <ol class="breadcrumb float-sm-left">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('super_admin.testimonials.index') }}">Testimonials</a>
                        </li>
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-secondary">
                        ...
                        <form id="quickForm" method="POST"
                            action="{{ route('super_admin.testimonials.update', ['testimonial' => $testimonial->id]) }}"
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input required type="text" name="name" value="{{ $testimonial->name }}"
                                    ...
                                    <div class="col-md-12 col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="category" value="{{ $testimonial->category }}"
                                                class="form-control @if ($errors->has('category')) is-invalid @endif"
                                                id="InputCategory" placeholder="Please Enter"
                                                aria-describedby="CategoryError" aria-invalid="true">
                                    ...
                                    <div class="col-md-12 col-lg-4">
                                        <div class="form-group">
                                            <label for="InputCategory">Service</label>
                                            <select aria-describedby="ServiceError" aria-invalid="true" id="service_id"
                                                class="form-control @if ($errors->has('service_id')) is-invalid @endif"
                                                name="service_id">
                                            ...
                                            <span id="ServiceError" class="error invalid-feedback">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="description" id="discription_editor"
                                                ...
                                                aria-describedby="DescriptionError" aria-invalid="true">{{ $testimonial->description }}</textarea>
                                    ...
                                    <div class="col-md-12 col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <select name="type" id="InputType"
                                                ...
                                                <option value="text"
                                                    {{ $testimonial->type == 'text' ? 'selected' : '' }}>Text</option>
                                                <option value="video"
                                                    {{ $testimonial->type == 'video' ? 'selected' : '' }}>Video</option>
                                            </select>
                                    ...
                                    <div class="col-md-12 col-lg-4">
                                        <div class="form-group">
                                            <label for="InputImage">Choose Picture of the User</label>
                                            ...
                                            @if ($testimonial->image)
                                                <div class="custom-file-preview">
                                                    <img src="{{ url($testimonial->image) }}" width="75px"
                                                        height="75px" alt="{{ $testimonial->name }}">
                                                </div>
                                            @else
                                                <div class="custom-file-preview">
                                                    -- No Image Selected
                                    ...
                                    <div class="col-md-12 col-lg-4">
                                        <div class="form-group">
                                            <label for="InputVideo">Choose Video Testimony</label>
                                            <input type="hidden" name="video" class="video" value="">
                                            <input type="file" name="video_path"
                                                class="form-control videoFile @if ($errors->has('video_path')) is-invalid @endif"
                                                id="InputVideo" placeholder="Select video" aria-describedby="VideoError"
                                                aria-invalid="true">
                                            <span id="VideoError" class="error invalid-feedback">
                                            ...
                                            @if ($testimonial->video_path)
                                                <div class="custom-file-preview">
                                                    <video class="w-100" controls>
                                                        <source src="{{ url($testimonial->video_path) }}"
                                                            type="video/mp4">
                                    ...
                                    <div class="col-md-12 col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="position" value="{{ old('position', $testimonial->position) }}"
                                                ...
                                                id="InputPosition" placeholder="Enter Position"
                                                aria-describedby="PositionError" aria-invalid="true">
                                            <span id="PositionError" class="error invalid-feedback">
