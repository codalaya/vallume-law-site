        ...
        <div class="row mb-4 pt-4 pt-lg-0">
            ...
            <div class="col-sm-6">
                ...
                <ol class="breadcrumb float-sm-left">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('super_admin.law_firm_categories.index') }}">LawFirm Categories</a></li>
                    <li class="breadcrumb-item active">
                        Add LawFirm Category
                    </li>
                </ol>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="card card-secondary">
                    ...
                    <!-- form start -->
                    <form id="quickForm" method="POST" action="{{ route('super_admin.law_firm_categories.store') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                        <div class="row">
                            <div class="w-100">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <select aria-describedby="MainCategoryError" aria-invalid="true" id="law_firm_main_categories_drop_down" class="form-control curr-sym @if ($errors->has('parent_category_id')) is-invalid @endif" name="parent_category_id">
