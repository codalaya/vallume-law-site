                ...
                <div class="col-md-5">
                    <div class="d-flex justify-content-start justify-content-md-end">
                        ...
                        @if (auth()->user()->hasPermission('company_page.export'))
                            <a href="{{ route('super_admin.company_pages.export') }}?{{ $params ? $params : '' }}"
                                class="btn btn-light">
                        ...
                        @if (auth()->user()->hasPermission('company_page.add'))
                            <a href="{{ route('super_admin.company_pages.create') }}" class="btn btn-primary  ml-2">
                                <i class="fa fa-plus-circle" aria-hidden="true"></i><span class="ml-2">Add Company Page</span>
                            </a>
                        @endif
                        <x-super-admin.import-modal importUrl="{{ route('super_admin.company_pages.import') }}">
