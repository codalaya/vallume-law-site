    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                ...
                @endif
                {{--
                @if ($user && ($user->hasPermission('lawyer_main_category.index') || $user->hasPermission('lawyer.index') || $user->hasPermission('lawyer_category.index')))
                    <li class="nav-item">
                        <a class="nav-link d-flex align-items-center justify-content-between @if (Route::is('super_admin.lawyers.*') || Route::is('super_admin.lawyer_categories.*') || Route::is('super_admin.lawyer_main_categories.*') || Route::is('super_admin.lawyer_posts.*') || Route::is('super_admin.lawyer_events.*') || Route::is('super_admin.lawyer_educations.*') || Route::is('super_admin.lawyer_certifications.*') || Route::is('super_admin.lawyer_experiences.*') || Route::is('super_admin.lawyer_broadcasts.*') || Route::is('super_admin.lawyer_podcasts.*') || Route::is('super_admin.lawyer_archives.*')) nav-link-active @endif"
                            data-toggle="collapse" href="#collapse100" role="button"
                            aria-expanded="@if (Route::is('super_admin.lawyers.*') || Route::is('super_admin.lawyer_categories.*') || Route::is('super_admin.lawyer_main_categories.*')) @php echo 'true' @endphp@else@php echo 'false' @endphp @endif"
                        ...
                        <div class="@if (Route::is('super_admin.lawyers.*') || Route::is('super_admin.lawyer_categories.*') || Route::is('super_admin.lawyer_main_categories.*') || Route::is('super_admin.lawyer_posts.*') || Route::is('super_admin.lawyer_events.*') || Route::is('super_admin.lawyer_educations.*') || Route::is('super_admin.lawyer_certifications.*') || Route::is('super_admin.lawyer_experiences.*') || Route::is('super_admin.lawyer_broadcasts.*') || Route::is('super_admin.lawyer_podcasts.*') || Route::is('super_admin.lawyer_archives.*')) collapsed show @else collapse @endif"
                            id="collapse100">
                            <ul class="text-white">
                                ...
                                @endif
                                @if ($user && ($user->hasPermission('lawyer.index') || $user->hasPermission('lawyer.add_blog') || $user->hasPermission('lawyer.add_event') || $user->hasPermission('lawyer.add_archive') || $user->hasPermission('lawyer.add_podcast') || $user->hasPermission('lawyer.add_media') || $user->hasPermission('lawyer.add_education') || $user->hasPermission('lawyer.add_certification') || $user->hasPermission('lawyer.add_experience')))
                                    <li>
                                        <a href="{{ route('super_admin.lawyers.index') }}"
                                            class="nav-link-sub @if (Route::is('super_admin.lawyers.*') || Route::is('super_admin.lawyer_posts.*') || Route::is('super_admin.lawyer_events.*') || Route::is('super_admin.lawyer_educations.*') || Route::is('super_admin.lawyer_certifications.*') || Route::is('super_admin.lawyer_experiences.*') || Route::is('super_admin.lawyer_broadcasts.*') || Route::is('super_admin.lawyer_podcasts.*') || Route::is('super_admin.lawyer_archives.*')) nav-link-sub-active @endif">Lawyers</a>
                ...
                @endif
                @if ($user && ($user->hasPermission('law_firm_main_category.index') || $user->hasPermission('law_firm.index') || $user->hasPermission('law_firm_category.index')))
                    <li class="nav-item">
                        <a class="nav-link d-flex align-items-center justify-content-between @if (Route::is('super_admin.law_firms.*') || Route::is('super_admin.law_firm_categories.*') || Route::is('super_admin.law_firm_main_categories.*') || Route::is('super_admin.law_firm_posts.*') || Route::is('super_admin.law_firm_events.*') || Route::is('super_admin.law_firm_educations.*') || Route::is('super_admin.law_firm_certifications.*') || Route::is('super_admin.law_firm_experiences.*') || Route::is('super_admin.law_firm_broadcasts.*') || Route::is('super_admin.law_firm_podcasts.*') || Route::is('super_admin.law_firm_archives.*')) nav-link-active @endif"
                            data-toggle="collapse" href="#collapse101" role="button"
                            aria-expanded="@if (Route::is('super_admin.law_firms.*') || Route::is('super_admin.law_firm_categories.*') || Route::is('super_admin.law_firm_main_categories.*')) @php echo 'true' @endphp@else@php echo 'false' @endphp @endif"
                        ...
                        <div class="@if (Route::is('super_admin.law_firms.*') || Route::is('super_admin.law_firm_categories.*') || Route::is('super_admin.law_firm_main_categories.*') || Route::is('super_admin.law_firm_posts.*') || Route::is('super_admin.law_firm_events.*') || Route::is('super_admin.law_firm_educations.*') || Route::is('super_admin.law_firm_certifications.*') || Route::is('super_admin.law_firm_experiences.*') || Route::is('super_admin.law_firm_broadcasts.*') || Route::is('super_admin.law_firm_podcasts.*') || Route::is('super_admin.law_firm_archives.*')) collapsed show @else collapse @endif"
                            id="collapse101">
                            <ul class="text-white">
                                ...
                                @if ($user && $user->hasPermission('law_firm.index'))
                                    <li><a href="{{ route('super_admin.law_firms.index') }}"
                                            class="nav-link-sub @if (Route::is('super_admin.law_firms.*') || Route::is('super_admin.law_firm_posts.*') || Route::is('super_admin.law_firm_events.*') || Route::is('super_admin.law_firm_educations.*') || Route::is('super_admin.law_firm_certifications.*') || Route::is('super_admin.law_firm_experiences.*') || Route::is('super_admin.law_firm_broadcasts.*') || Route::is('super_admin.law_firm_podcasts.*') || Route::is('super_admin.law_firm_archives.*')) nav-link-sub-active @endif">LawFirms</a>
                                    </li>
                                @endif
                ...
                @if ($user && $user->hasPermission('company_page.index'))
                    ...
                    {{-- <li class="nav-item">
                        <a href="{{ route('super_admin.app_carousels.index') }}"
                            class="nav-link @if (Route::is('super_admin.app_carousels.*')) nav-link-active @endif">
                            <span class="shape-1"></span>
                            <span class="shape-2"></span>
                            <i class="fa-solid fa-sliders icon-size"></i>
                            <span class="text">
                                App Carousel
                            </span>
                        </a>
                            ...
                            <ul class="text-white">
                                ...
                                <li class="nav-item">
                                    ...
                                    <div class="@if (Route::is('super_admin.pages_contents.*')) collapsed show @else collapse @endif"
                                        ...
                                        <ul class="text-white" style="list-style-type: circle">
                                            <li><a href="{{ route('super_admin.pages_contents.get', 'vallume_gpt') }}"
                                                    class="nav-link-sub">Vallume GPT </a></li>
                                        </ul>
                                    ...
                                    {{--    <ul class="text-white" style="list-style-type: circle">
                                        ...
                                        <ul class="text-white" style="list-style-type: circle">
                                            <li class="list-style-cicrle"><a
                                                    href="{{ url('super_admin/filament/landing-page-setting')}}"
                                                    class="nav-link-sub">Landing Page Setting</a>
                                            </li>
                                        </ul>
                                        <ul class="text-white" style="list-style-type: circle">
                                            <li class="list-style-cicrle"><a
                                                    href="{{ url('super_admin/filament/about-page-setting')}}"
                                                    class="nav-link-sub">About Us Page Setting</a>
                                            </li>
                                        </ul>
                                        <ul class="text-white" style="list-style-type: circle">
                                            <li class="list-style-cicrle"><a
                                                    href="{{ url('super_admin/filament/gpt-page-setting')}}"
                                                    class="nav-link-sub">GPT Page Setting</a>
                                            </li>
                                        </ul>
                                        <ul class="text-white" style="list-style-type: circle">
                                            <li class="list-style-cicrle"><a
                                                    href="{{ url('super_admin/filament/pre-registrations')}}"
                                                    class="nav-link-sub">Pre-Registrations</a>
                                            </li>
                                        </ul>
                        ...
                        <div class="@if (Route::is('super_admin.general_settings.*') ||
                            ...
                            <ul class="text-white">
                                <li><a href="{{ route('super_admin.version_upgrade.index') }}"
                                        class="nav-link-sub @if (Route::is('super_admin.version_upgrade.*')) nav-link-sub-active @endif">About
                                        & Upgrade</a>
                                </li>
                                ...
                                @endif
                                @if ($user && $user->hasPermission('configurations_setting.index'))
                                    <li><a href="{{ route('super_admin.specific_settings.email.configurations') }}"
                                            class="nav-link-sub @if (Route::is('super_admin.specific_settings.email.configurations.*')) nav-link-sub-active @endif">Email
                                            Configuration
                                            Settings</a>
                                    </li>
                                @endif
                                @if ($user)
                                    <li><a href="{{ route('super_admin.theme_settings.index') }}"
                                            class="nav-link-sub @if (Route::is('super_admin.theme_settings.index.*')) nav-link-sub-active @endif">Theme
                                            Settings</a>
                                    </li>
                                @endif
                                @if ($user)
                                    <li><a href="{{ route('super_admin.home_page.index') }}"
                                            class="nav-link-sub @if (Route::is('super_admin.home_page.index.*')) nav-link-sub-active @endif">Home
                                            Page
                                            Settings</a>
                                    </li>
                                @endif
                                <li><a href="{{ route('super_admin.seo_settings.index') }}"
                                        class="nav-link-sub @if (Route::is('super_admin.seo_settings.index.index.*')) nav-link-sub-active @endif">
                                        SEO Settings</a></li>
                                ...
                                @endif
                                <li><a href="{{ route('super_admin.system_info.index') }}"
                                        class="nav-link-sub @if (Route::is('super_admin.system_info.*')) nav-link-sub-active @endif">System
                                        Info</a>
                                </li>
                                <li><a href="{{ route('super_admin.clear_cache.index') }}"
                                        class="nav-link-sub @if (Route::is('super_admin.clear_cache.*')) nav-link-sub-active @endif">Clear
                                        Cache</a>
                                </li>
                                @if ($user && $user->hasPermission('role.index'))
