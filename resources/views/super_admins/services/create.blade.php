            ...
            <div class="row mb-4 pt-4 pt-lg-0">
                ...
                <div class="col-sm-6">
                    ...
                    <ol class="breadcrumb float-sm-left">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('super_admin.services.index') }}">Service</a></li>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-secondary">
                        ...
                        <!-- form start -->
                        <form id="quickForm" method="POST" action="{{ route('super_admin.services.store') }}"
                                ...
                                <div>
                                    ...
                                    <div class="tab-content mt-2 p-2" id="myTabContent">
                                        ...
                                        <div class="tab-pane fade mb-2 {{$key == 0 ? 'show active':''}}" id="nav-{{$language->code}}" role="tabpanel" aria-labelledby="nav-{{$language->code}}-tab">
                                            ...
                                            <div class="form-group">
                                                <label for="InputDescription">Full Description ({{$language->code}})</label>
                                                <textarea name="full_description[{{$language->code}}]" id="full_discription_editor_{{$language->code}}" class="form-control @if ($errors->has('full_description.'.$language->code)) is-invalid @endif" rows="3" placeholder="Please Enter" aria-describedby="FullDescriptionError-{{$language->code}}" aria-invalid="true"></textarea>
                                                <span id="full_DescriptionError-{{$language->code}}" class="error invalid-feedback">
                                ...
                                @if (isset($service_categories))
                                    <div class="col-md-12 col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <select aria-describedby="ServiceCategoryError" aria-invalid="true"
                                                id="faq_categories_drop_down"
                                                class="form-control curr-sym @if ($errors->has('service_category_id')) is-invalid @endif"
