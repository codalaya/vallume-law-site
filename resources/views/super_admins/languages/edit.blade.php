                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-secondary">
                        ...
                        <form id="quickForm" method="POST"
                            action="{{ route('super_admin.languages.update', ['language' => $language->id]) }}"
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="code" value="{{ $language->code }}"
                                                ...
                                                id="InputCode" placeholder="Please Enter" aria-describedby="CodeError"
                                                aria-invalid="true">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="description" id="discription_editor"
                                                ...
                                                aria-describedby="DescriptionError" aria-invalid="true">{{ $language->description }}</textarea>
                                    ...
                                    <div class="col-md-12 col-lg-4">
                                        <div class="form-group">
                                            <label for="InputLangFile">Language File</label>
                                            <input type="file" name="language_file"
                                                class="custom-file-input @if ($errors->has('language_file')) is-invalid @endif"
                                                id="InputLangFile" accept=".php" aria-describedby="LangFileError" aria-invalid="true">
                                            <span id="LangFileError" class="error invalid-feedback">
                                        ...
                                        <div class="form-group">
                                            ...
                                            @if ($language->image)
                                                <div class="custom-file-preview">
                                                    <img src="{{ url($language->image) }}" width="75px" height="75px"
                                                        alt="{{ $language->name }}">
                                                </div>
                                            @else
                                                <div class="custom-file-preview">
                                    ...
                                    <div class="col-md-12 col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <div class="custom-control custom-switch">
                                                ...
                                                <label class="custom-control-label" for="customSwitch1">Select Language To
                                                    Be
                                                    Active
                                                    Or Not</label>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="custom-control custom-switch">
                                                <input type="checkbox" name="is_default" value="1"
                                                    ...
                                                    aria-describedby="IsDefaultError" aria-invalid="true">
                                                <label class="custom-control-label" for="customSwitch2">Select Language To
                                                    Be
                                                    Default
                                                    Or Not</label>
                                            </div>
