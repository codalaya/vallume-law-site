...
{{-- @dd($appointment) --}}
                    <div class="card-body">
                        ...
                        <p class="card-text">Meeting Lawyer ID: <strong>{{ $appointment->lawyer_id }}</strong></p>
                        <p class="card-text">Meeting Lawyer Name:
                            <strong>{{ $appointment->lawyer ? $appointment->lawyer->name : 'No Name' }}</strong>
                        </p>
                        ...
                        <a href="{{ url('/lawyer_appointment_log/detail/' . $appointment->id) }}"
