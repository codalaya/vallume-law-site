<template>
    <nav class="navbar navbar-expand-lg navbar-light bg-transparent" :class="{ sticky: !view.topOfPage }">
        <div class="container">
            <a class="navbar-brand" href="#">
                <Link :href="route('home')">
                <img v-if="$page.props && $page.props.settings && $page.props.settings.logo" height="70"
                ...
                <span v-else class="text-white mt-4">
                    {{ $page.props && $page.props.settings && $page.props.settings.site_title ?
                        $page.props.settings.site_title : __('lawyer consultant') }}
                </span>
                </Link>
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent" style="flex-grow: inherit">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <Link class="nav-link" :href="route('gpt-coming-soon')">
                        {{ __("Vallume GPT") }}
                        </Link>
                    </li>
                    <!-- <li class="nav-item">
            ...
            <Link class="nav-link" :href="route('forum')">
              {{ __("forum") }}
                    ...
                    <!-- <li class="nav-item dropdown"
                        v-if="$page.props.company_pages && $page.props.company_pages.length > 0">

                        <a class="nav-link dropdown-toggle" href="#" id="companyPagesDropDown" role="button"
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="companyPagesDropDown">
                            <li v-for="company_page in $page.props.company_pages" :key="company_page.id">
                                <Link class="dropdown-item"
                                    :href="route('company_pages.display', { slug: company_page.slug })">
                                {{ company_page.name }}
                                </Link>
                            </li>
                    ...
                    <li class="nav-item" v-if="!$page.props.auth">
                        <Link :href="route('login')" class="nav-link"><i class="bi bi-box-arrow-in-right"></i> {{
                            __("login") }}</Link>
                    </li>
                        ...
                        <div class="dropdown">
                            <button
                                ...
                                <!-- <span class="position-absolute badge rounded-pill bg-primary"
                                    style="right: 0px; top: -10px;">{{ __($page.props.auth.logged_in_as) }}</span> -->
                ...
                >
                  ...
                  >
                                ...
                                <li>
                                    ...
                                    <button style="pointer: cursor" @click="logout()" class="dropdown-item">
