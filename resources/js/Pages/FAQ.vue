                        ...
                        <div class="col-lg-12">
                            <div>
                                <h2 class="fs-2 text-center font-header">
                                    <span class="fw-normal text-secondary">{{ __('Explore') }}| </span>
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb justify-content-center mb-0">
                                    <li class="breadcrumb-item">
                                        <a href="#" class="text-decoration-none link-primary">{{ __('Home') }}</a>
                                    </li>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-12" v-if="faq_categories.length > 0">
                            <div class="accordion" id="accordionExample">
                                <div class="accordion-item mt-3" v-for="cat in faq_categories" :key="cat.id">
                                    ...
                                    <div :id="'collapse' + cat.id" class="accordion-collapse collapse show"
                                        ...
                                        <div class="accordion-body">
                                            <div class="accordion" id="accordionExample2">
                                                <div class="accordion-item mt-1" v-for="faq in cat.faqs" :key="faq.id">
