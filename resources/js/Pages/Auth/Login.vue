                    ...
                    <div class="col-md-6">
                        <div>
                            ...
                            <div v-if="getPageContentType('login_page_description') == 'textarea'">
                                <div v-html="getPageContent('login_page_description')" class="font-subheader text-white"> </div>
                            </div>
                            <div v-else-if="getPageContentType('login_page_description') == 'text'">
                                <p> {{ getPageContent('login_page_description') ?? '-' }} </p>
                            </div>
                            <div v-else>
                                <p class="fs-3 mb-0 text-white mt-3 font-header">
                                    Welcome to |
                                    <span class="text-primary">Vallume</span>
                                </p>
                            ...
                            <div class="text-primary py-5">
                                ...
                                <h1 v-else class="fw-bold display-1 mb-4 text-capitalize font-header">{{
                                    getPageContent('login_page_login_text') ?? __('login as') }}</h1>
                                <ul class="nav nav-tabs mb-4" id="myTab" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link text-capitalize" :class="{ active: tab == 'user' }"
                                            @click="changeTab('user', 0)" id="customer-login-tab" data-bs-toggle="tab"
                                            data-bs-target="#customer-login-pane" type="button" role="tab"
                                            aria-controls="customer-login-pane" aria-selected="true">{{ __('user')
                                            }}</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link text-capitalize" :class="{ active: tab == 'lawyer' }"
                                            @click="changeTab('lawyer', 1)" id="lawyer-login-tab" data-bs-toggle="tab"
                                            data-bs-target="#lawyer-login-pane" type="button" role="tab"
                                            aria-controls="lawyer-login-pane" aria-selected="false">{{ __('lawyer')
                                            }}</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link text-capitalize" :class="{ active: tab == 'student' }"
                                            @click="changeTab('student', 2)" id="student-login-tab" data-bs-toggle="tab"
                                            data-bs-target="#student-login-pane" type="button" role="tab"
                                            aria-controls="student-login-pane" aria-selected="false">{{ __('student')
                                            }}</button>
                                    </li>
                                </ul>
                                <div class="tab-content" id="myTabContent">
                                    <customer-login :active="tab == 'user'"
                                        :redirectUrl="redirect_url"></customer-login>
                                    <lawyer-login :active="tab == 'lawyer'"></lawyer-login>
                                    <student-login :active="tab == 'student'"></student-login>
                                </div>
                            </div>
                        </div>
                        ...
                        <Carousel ref="carousel" v-model="currentSlide" :settings="settings" :breakpoints="breakpoints">
                            <Slide v-for="slide in 1" :key="slide">
                                <div class="carousel__item">
                                    <img style="position: relative;" src="@/images/home/slider-img.png" alt
                            ...
                            <div class="row justify-content-center pb-3">
                                <div class="col-md-4 px-4 mt-3">
                                    <div class="card bg-transparent border-0">
                                        <div class="card-body py-5 rounded-top-pill bg-white"
                                            ...
                                            <div class="tag text-center py-2 mx-5 mb-4 text-white fs-3 rounded-pill"
                                                style="background-color: #3F3F3F;">$0.00/month</div>
                                            <ul class="ps-0 mb-0">
                                                <li
                                                    ...
                                                    <i class="bi fs-2 bi-check position-absolute"
                                                        style="right:10px; top:8px;"></i>
                                                </li>
                                                <li
                                                    class="bg-light p-3 mb-3 d-flex justify-content-between position-relative">
                                                    <div class="d-flex">
                                                    ...
                                                    <i class="bi fs-2 bi-x position-absolute"
                                                        style="right:10px; top:8px;"></i>
                                                </li>
                                                <li
                                                    class="bg-light p-3 mb-3 d-flex justify-content-between position-relative">
                                        ...
                                        <div class="card-footer p-4 border-0 bg-white"
