        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="form-group mb-4">
                  ...
                  <input id="first_name" class="form-control py-3 border border-primary" :placeholder="__('first name')"
                ...
                <div class="form-group mb-4">
                  <div class="form-floating">
                  <input id="last_name" class="form-control py-3 border border-primary"  :placeholder="__('last name')"
                ...
                <div class="form-group mb-4">
                  <div class="form-floating">
                  <input id="user_name" class="form-control py-3 border border-primary"  :placeholder="__('user name')"
                ...
                <div class="form-group mb-4">
                  <div class="form-floating">
                  <input id="zip_code" class="form-control py-3 border border-primary"  :placeholder="__('zip code')"
        ...
        <div class="row align-items-center">
            <div class="col-12 mb-3">
                <div class="form-check">
                  <div v-if="this.errors.terms" class="error-validation text-end">
                    ...
                    <label class="form-check-label" style="font-size: 14px;" for="flexCheckDefault">
                    {{ __('terms changes') }}
                        <a  class="link-primary" :href="route('company_pages.display',{slug:'terms'})" target="_blank">{{ __('terms of use') }} &{{ __('condition') }} </a>

                        {{ __('and the') }}<a class="link-primary"  :href="route('company_pages.display',{slug:'privacy'})" target="_blank"> {{ __('privacy policy') }}</a>
                    </label>
                </div>
            </div>
          <div class="col-md-4">
          ...
          <div class="col-md-8 text-end">
            <p class="mb-0">{{ __('already have a account') }}?
              <Link  :href="route('login',{tab:'law_firm'})" class="link ms-2 text-capitalize link-primary">{{ __('login') }}</Link>
            </p>
          </div>
        </div>
      </div>
