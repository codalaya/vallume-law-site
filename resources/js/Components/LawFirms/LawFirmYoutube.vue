    ...
    return {
      form: this.$inertia.form({
        settings: [{
          ...
          'display_name': this.__('youtube playlist link'),
          'value': this.$page.props.law_firm.law_firm_settings['youtube_playlist_link'] ?? "",
        },
        {
          'name': 'youtube_channel_link',
          'display_name': this.__('youtube channel link'),
          'value': this.$page.props.law_firm.law_firm_settings['youtube_channel_link'] ?? "",
        },
        ]
      }),
    };
