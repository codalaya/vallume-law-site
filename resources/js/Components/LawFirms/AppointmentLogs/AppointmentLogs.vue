<template>
    <div class>
        ...
        col.name }}</option>
                                        ...
                                        <law-firm-appointment-list-card
                                            :appointments="appointments"></law-firm-appointment-list-card>
                                        <div class="col-12">
...
import LawFirmAppointmentListCard from "@/Components/LawFirms/AppointmentLogs/LawFirmAppointmentListCard.vue";
...
export default defineComponent({
    ...
    methods: {
        ...
        getAppointmentFilterData(loading_more) {
            this.fetching = true
            axios.post(this.route('getApiLawFirmsFilterAppointmentLogs'), this.filter).then(res => {
