        ...
        <div class="row">
            <div class="col-12">
                <h2 class="fs-2 text-center font-header">
                    ...
                    <span class="fw-normal text-secondary">{{ __('Hello') }} {{ $page.props.auth.user.name }} | </span>
                    <span class="fw-bold text-primary"> {{ __('Profile') }}</span>
                </h2>
              ...
              <button class="nav-link w-100 text-dark" :class="{ active: active_tab == 'instagram' }"
                ...
                <div class="col-md-9 ">
                    ...
                    <div class="tab-content w-100 p-4" id="v-pills-tabContent">
                        ...
                        <lawyer-services :active="active_tab == 'services'"></lawyer-services>
                        <lawyer-events
