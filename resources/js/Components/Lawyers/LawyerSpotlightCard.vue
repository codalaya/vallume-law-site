            ...
            <div class="card-body p-0">
                <div class="row">
                    ...
                    <div class="col-lg-9">
                        <div class="d-md-flex align-items-center justify-content-between mb-3">
                            <div class="d-flex custom mb-md-0 mb-3 align-items-start">
                ...
                <div class="row mx-0 pt-3 mt-3 g-0 appoint-buttons"
                    ...
                    <div class="col-md-4 mb-3 pe-3" v-for="(schedule_type, index) in lawyer.appointment_types" :key="index">
                        <div class="d-flex" @click="checkLoginAndRedirect(lawyer, schedule_type.appointment_type)" style="background-color: var(--tertiary-color); border-radius:15px; cursor: pointer;">
                            ...
                            <div class="p-2 text-start text-dark">
