        ...
        <Modal maxWidth="lg" :id="id">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input v-model="form.price" class="w-100 form-control  px-3"
                                    :class="{ 'is-invalid': form.errors.price }" placeholder="Please Enter"
                                    type="number" />
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input id="lawyer-image" class="w-100 custom-file-input" ref="formImage"
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger text-white" data-bs-dismiss="modal">{{ __('close')
                        }}</button>
...
export default defineComponent({
    ...
    methods: {
        ...
        create() {
            this.form.post(this.route('lawyers.lawyer_services.store'), {
                preserveState: true,
                preserveScroll: true,
                onSuccess: () => {
        ...
        update() {
            this.form.transform((data) => ({
                ...data,
                _method: "PUT",
            })).post(this.route('lawyers.lawyer_services.update', { lawyer_service: this.modalData.id }), {
                preserveState: true,
                preserveScroll: true,
                onSuccess: () => {
