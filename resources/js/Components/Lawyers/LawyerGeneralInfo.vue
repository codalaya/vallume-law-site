    ...
    <div class="tab-pane" :class="{ active: active }" id="general-info" role="tabpanel"
        ...
        <ul class="nav nav-pills top-navs justify-content-between" id="pills-tab" role="tablist">
            <li class="nav-item" role="presentation">
                <button class="nav-link active" id="gen-info-tab" data-bs-toggle="pill" data-bs-target="#gen-info"
            ...
            <li class="nav-item" role="presentation" @click="() => this.active_tab = 'experience_tab'">
                <button class="nav-link" id="experience-info-tab" data-bs-toggle="pill"
            ...
            <li class="nav-item" role="presentation" @click="() => this.active_tab = 'education_tab'">
                <button class="nav-link" id="educational-info-tab" data-bs-toggle="pill"
                    ...
                    <div class="row">
                        <div class="col-12 position-relative">
                            ...
                            <div class="cover-header rounded-2"
                                v-if="!form.cover_image && !$page.props.lawyer.cover_image">
                            ...
                            <div class="cover-header rounded-2"
                                v-if="!form.cover_image && $page.props.lawyer.cover_image"
                                v-bind:style="{ 'background-image': 'url(' + $page.props.lawyer.cover_image + ')' }">
                            </div>
                        ...
                        <div class="col-md-3">
                            <label for="lawyer-image">
                                ...
                                <button data-bs-toggle="modal" id="ImageCropperModalButton"
                                    data-bs-target="#imageCropModal" style="display: none"></button>
                            ...
                            <div class="row">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div>
                                            ...
                                            <input id="lawyer-image" style="display: none" @change="onFileChange"
                                                type="file" />
                                            <input id="lawyer-cover-image" style="display: none"
                                                @change="onFileChangeCover" type="file" />
                                        ...
                                        <div class=""
                                            v-if="$page.props.settings.commission_type == 'subscription_base'">
                                            <label for="subscription" class="me-2"><b>{{ __("package plan")
                                                    }}:</b></label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <Multiselect v-model="form.experience" :close-on-select="true"
                                            :searchable="true" :options="experienceOptions" valueProp="value"
                                            label="name" />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                ...
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    <li v-for="(lang, index) in $page.props.translation_languages" :key="lang.id"
                                        ...
                                        <button :class="{ 'active': index == 0 }" class="nav-link mr-1"
                                            :id="`nav-${lang.code}-tab`" data-bs-toggle="tab"
                                            :data-bs-target="`#nav-${lang.code}`" type="button" role="tab"
                                            :aria-controls="`nav-${lang.code}`" aria-selected="true">{{ lang.name
                                            }}</button>
                                    </li>
                                </ul>
                                    ...
                                    <div :class="{ 'show active': secondIndex == 0 }" class="tab-pane fade mb-2"
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group mb-3">
                                                ...
                                                <textarea
                                                    :class="{ 'is-invalid': form.errors[`description.${lang.code}`] }"
                                                        ...
                                                        <div class="form-group mb-3">
                                                            ...
                                                            <div class="input-group-from position-relative">
                                                                <vue-google-autocomplete id="map" ref="address"
                                                                    enable-geolocation
                                                                    classname="w-100 form-control px-3" :placeholder="__(
                                                                        'please enter'
                                                                    )
                                                        ...
                                                        <div class="form-group mb-3 position-relative">
                                                            ...
                                                            <textarea :disabled="disable_fields
                                                                " v-model="form.address_line_2
                                                                        " class="w-100 form-control px-3" placeholder="Please Enter" type="text"></textarea>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group mb-3">
                                                            ...
                                                            <Multiselect :placeholder="__('please select')
                                                                " v-model="form.tags" valueProp="id" label="name"
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group mb-3">
                                                            ...
                                                            <Multiselect :placeholder="__('please select')
                                                                " v-model="form.languages" valueProp="id"
                                                                label="name" mode="tags" :close-on-select="false"
                                                                :searchable="true" :options="this.languages
                                                                    " />
                                                        </div>
                                                    </div>
