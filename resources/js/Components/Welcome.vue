    ...
    <div class="col-md-12">
      <div class="card shadow bg-light">
        <div class="card-body bg-white px-5 py-3 border-bottom rounded-top">
          <div class="mx-3 my-3">
            <div>
              <application-logo style="width: 317px" />
            </div>

            <h3 class="h3 my-4">Welcome to your stream application!</h3>

            <div class="text-muted">
              Laravel stream provides a beautiful, robust starting point for
              your next Laravel application. Laravel is designed to help you
              build your application using a development environment that is
              simple, powerful, and enjoyable. We believe you should love
              ...
              <div class="d-flex flex-row bd-highlight mb-3">
                ...
                <div class="ps-3">
                  ...
                  <p class="text-muted">
                    ...
                    Laravel stream, as well as support for user email
                    verification and resetting forgotten passwords. So, you're
                    free to get started what matters most: building your
                    application.
                  </p>
                </div>
              </div>
