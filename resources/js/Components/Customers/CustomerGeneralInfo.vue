    ...
    <form @submit.prevent="submit" class="profileForm">
      <div class="row">
        <div class="col-12 position-relative">
            ...
            <div class="cover-header" v-if="!form.cover_image && !$page.props.customer.cover_image">
            </div>
            <div v-if="form.cover_image" class="cover-header"
            ...
            <div class="col-md-3">
                <div >
                    <label for="lawyer-image">
                        ...
                        <div class="profile-image mx-4 mb-5 shadow position-relative" style="background-color:#E4E4E4; width:220px">
