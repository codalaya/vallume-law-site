                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div v-if="currentTab === index">
                                        ...
                                        <customer-appointment-list-card
                                            :appointments="appointments"></customer-appointment-list-card>
                                        <div class="col-12">
...
import CustomerAppointmentListCard from "@/Components/Customers/CustomerAppointmentListCard.vue";
...
export default defineComponent({
    ...
    methods: {
        ...
        getAppointmentFilterData(loading_more) {
            this.fetching = true
            axios.post(this.route('getApiFilterAppointmentLogs'), this.filter).then(res => {
