<template>
    <div class="service-search-component">
        <div v-if="home">
            <div class="row">
                <div class="col-md-4">
                    <select v-model="form.blog_category" class="form-select border-0 py-3" aria-label="Select Category">
                ...
                <div class="col-md-4">
                    <input type="text" class="form-control border-0 py-3" v-model="form.search" id="findPostSearchHome"
                ...
                <div class="col-md-4">
                    <div class="d-flex">
                        ...
                        <button :href="route('blogs.listing')" @click="submit" class="btn btn-primary ms-3" type="submit">
                        ...
                        <div class="row flex-column">
                            <div class="col-md-4 w-100 mb-4">
                                <select v-model="form.blog_category" class="form-select" aria-label="Select Category">
                                    <option value selected>{{ __('select') }} {{ __('category') }}</option>
                                    <option v-for="cat in blog_categories" :key="cat.id" :value="cat.slug">{{ cat.name }}
                                    </option>
                                </select>
                            </div>
                            <div class="col-md-4 w-100 mb-4">
                                <input type="text" v-model="form.search" class="form-control" id="findPostSearchListing"
                                    :placeholder="__('search')" />
                            </div>
                            <div class="col-md-4 w-100 mb-4">
                            ...
                            <div class="d-grid">
                                <button :href="route('blogs.listing')" @click="submit" class="btn btn-primary" type="submit"
                                    :disabled="isLoading">
