    ...
    return {
      form: this.$inertia.form({
        settings: [ {
          ...
          'value': this.$page.props.law_firm.law_firm_settings['facebook_url'] ?? "",
        },
        {
          'name': 'twitter_url',
          'display_name':this.__('twitter url') ,
          'value': this.$page.props.law_firm.law_firm_settings['twitter_url'] ?? "",
        },
        {
          'name': 'youtube_url',
          'display_name': this.__('youtube url'),
          'value': this.$page.props.law_firm.law_firm_settings['youtube_url'] ?? "",
        },
        {
          'name': 'tiktok_url',
          'display_name': this.__('tiktok url'),
          'value': this.$page.props.law_firm.law_firm_settings['tiktok_url'] ?? "",
        },
        {
          'name': 'linkedin_url',
          'display_name': this.__('linkdein url'),
          'value': this.$page.props.law_firm.law_firm_settings['linkedin_url'] ?? "",
        },
        {
          'name': 'whatsapp_url',
          'display_name':this.__('whatsapp url'),
          'value': this.$page.props.law_firm.law_firm_settings['whatsapp_url'] ?? "",
        },
        {
          'name': 'snapchat_url',
          'display_name': this.__('snapchat url'),
          'value': this.$page.props.law_firm.law_firm_settings['snapchat_url'] ?? "",
        },
        {
          'name': 'instagram_url',
          'display_name': this.__('instragram url'),
          'value': this.$page.props.law_firm.law_firm_settings['instagram_url'] ?? "",
        },
        {
          'name': 'pinterest_url',
          'display_name': this.__('pinterest url'),
          'value': this.$page.props.law_firm.law_firm_settings['pinterest_url'] ?? "",
        }
        ]
      }),
    };
