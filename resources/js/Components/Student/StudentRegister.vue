<template>
    <div class="tab-pane" :class="{ active: active }" id="law_firm-register-pane" role="tabpanel"
        aria-labelledby="law_firm-register-pane" tabindex="0">
                    ...
                    <div class="col-12">
                        ...
                        <div class="form-group mb-4">
                            <div class="form-floating">
                                <input id="first_name" class="form-control py-3 border border-primary"
                                    :placeholder="__('first name')" type="text" v-model="form.first_name" />
                        ...
                        <div class="form-group mb-4">
                            <div class="form-floating">
                                <input id="last_name" class="form-control py-3 border border-primary"
                                    :placeholder="__('last name')" type="text" v-model="form.last_name" />
                        ...
                        <div class="form-group mb-4">
                            <div class="form-floating">
                                <input id="user_name" class="form-control py-3 border border-primary"
                                    :placeholder="__('user name')" type="text" v-model="form.user_name" />

                            </div>
                        </div>
                        <div class="form-group mb-4">
                            <div class="form-floating">
                                <input id="zip_code" class="form-control py-3 border border-primary"
                                    :placeholder="__('zip code')" type="text" v-model="form.zip_code" />
                        ...
                        <div class="form-group mb-4">
                            <div class="form-floating">
                                <input id="email" class="form-control py-3 border border-primary"
                        ...
                        <div class="form-group mb-4">
                            <div class="form-floating">
                                <input id="pass_log_log" class="form-control py-3 border border-primary" type="password"
                ...
                <div class="row align-items-center">
                    <div class="col-12 mb-3">
                        <div class="form-check">
                            ...
                            <input v-model="form.terms" class="form-check-input" type="checkbox" value=""
                                id="flexCheckDefault">
                      ...
                      {{ __('terms changes') }}
                        <a :href="route('company_pages.display',{slug:'terms'})" target="_blank">Terms of Use & Conditions</a>
                         ...
                         and the <a :href="route('company_pages.display',{slug:'privacy'})" target="_blank">Privacy Policy</a>
                            ...
                            <label class="form-check-label" style="font-size: 14px;" for="flexCheckDefault">
                                {{ __('terms changes') }}
                                <a class="link-primary" :href="route('company_pages.display', { slug: 'terms' })"
                                    target="_blank">{{ __('terms of use') }} &{{ __('condition') }} </a>

                                {{ __('and the') }}<a class="link-primary"
                                    :href="route('company_pages.display', { slug: 'privacy' })" target="_blank"> {{
                                    __('privacy policy') }}</a>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="col-md-8 text-end">
                        <p class="mb-0">{{ __('already have a account') }}?
                            <Link :href="route('login', { tab: 'law_firm' })"
                                class="link ms-2 text-capitalize link-primary">{{ __('login') }}</Link>
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-12">
            <div class="">
                ...
                <a :href="route('social_redirect', { provider: 'google', login_as: this.form.login_as })"
                    ...
                    <span class="buttonText text-black">{{ __('google') }}</span>
                </a>
                ...
                <a :href="route('social_redirect', { provider: 'facebook', login_as: this.form.login_as })"
                    ...
                    <span class="icon"></span>
                    <span class="buttonText text-black">{{ __('facebook') }}</span>
                </a>
            </div>
        </div>
    </div>
