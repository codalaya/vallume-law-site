<template>
    <div class="tab-pane" :class="{ active: active }" id="law_firm-login-pane" role="tabpanel"
        aria-labelledby="law_firm-login-tab" tabindex="0">
                    ...
                    <div class="col-12">
                        ...
                        <div class="input-group mb-4">
                            <div class="form-floating">
                                ...
                                <input id="pass_log_log" class="form-control py-3 border border-primary"
                                    style="border-top-right-radius: 0px !important; border-bottom-right-radius: 0px !important;"
                                    type="password" v-model="form.password" name="password"
                            ...
                            <span class="input-group-text" toggle="#password-field">
                                <Link style="color: var(--bs-primary);" class="text-decoration-none me-3"
                                    :href="route('forgot_password')">{{ __('forgot password') }}?</Link>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-8 text-end">
                        <p class="mb-0">
                            ...
                            <Link :href="route('register', { tab: 'law_firm' })"
                                class="link ms-2 text-capitalize link-primary">{{ __('register') }}</Link>
                        </p>
                    </div>
                </div>
            </div>
