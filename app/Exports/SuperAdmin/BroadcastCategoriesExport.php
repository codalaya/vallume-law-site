...
class BroadcastCategoriesExport implements FromArray, WithHeadings
{
    ...
    public function array(): array
    {
        ...
        foreach ($this->broadcast_categories as $broadcast_category) {
            $single = [$broadcast_category->id, $broadcast_category->name, $broadcast_category->description, $broadcast_category->is_active, $broadcast_category->slug, date_format($broadcast_category->created_at, 'd-m-Y')];
            $data[] = $single;
        }
        return $data;
    }
