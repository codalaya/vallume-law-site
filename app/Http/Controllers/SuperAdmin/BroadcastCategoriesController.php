...
use App\Exports\SuperAdmin\BroadcastCategoriesExport;
...
use App\Imports\SuperAdmin\BroadcastCategoriesImport;
...
class BroadcastCategoriesController extends Controller
{
  ...
  public function __construct()
  {
    ...
    public function export(Request $request)
    {
        ...
        return Excel::download(new BroadcastCategoriesExport($broadcast_categories), $filename);
    }
    /********* Import CSV And Excel  **********/
    public function import(ImportRequest $request)
    {
        $file = $request->file('file');
        Excel::import(new BroadcastCategoriesImport, $file);
