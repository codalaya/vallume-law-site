...
use App\Exports\SuperAdmin\PodcastsExports;
...
class PodcastsController extends Controller
{
  ...
  public function __construct()
  {
    ...
    public function export(Request $request)
    {
        ...
        return Excel::download(new PodcastsExports($podcasts), $filename);
    }
    ...
    public function import(ImportRequest $request)
    {
        ...
        return redirect()->back()->with('message', 'Podcasts imported Successfully')->with('message_type', 'success');
    }
