...
class TestimonialsController extends Controller
{
    ...
    public function edit(Testimonial $testimonial)
    {
        ...
        return view('super_admins.testimonials.edit', compact('testimonial',  'services'));
    }
    ...
    public function update(CreateRequest $request, Testimonial $testimonial)
    {
        ...
        try {
            ...
            if($request->hasFile('video_path')) {
                $data['video_path'] = uploadFile($request, 'video_path', 'videos', $testimonial->video_path);
            } else {
                $data['video_path'] = $testimonial->video_path;
            }
