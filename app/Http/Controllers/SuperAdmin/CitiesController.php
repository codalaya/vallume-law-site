...
class CitiesController extends Controller
{
  ...
  public function __construct()
  {
    ...
    public function index(Request $request)
    {
        ...
        $cities = $cities->get();
        return view('super_admins.cities.index',compact('cities'));
        }
        $countries = Country::get();
        return view('super_admins.cities.list',compact('countries'));
    }
    ...
    public function store(CreateRequest $request)
    {
        ...
        return redirect()->route('super_admin.countries.index')->with('message', 'City Created Successfully')->with('message_type', 'success');
    }
    ...
    public function update(CreateRequest $request, City $city)
    {
        ...
        return redirect()->route('super_admin.countries.index')->with('message', 'City Updated Successfully')->with('message_type', 'success');
    }
