...
class HandleInertiaRequests extends Middleware
{
    ...
    public function share(Request $request)
    {
        ...
        $company_pages = CompanyPage::active()->get();
        $all_company_pages = [];
        ...
        return array_merge(parent::share($request), [
            ...
            'globalPageData' => $this->globalPageData(),
        ]);
    }

    protected function globalPageData()
    {
        $value =  Cache::remember('global-page-data', 60 * 60, function () {
