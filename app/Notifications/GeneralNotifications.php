...
class GeneralNotifications extends Notification
{
    ...
    public function toMail($notifiable)
    {
        ...
        if($this->notification_setting_name == 'new_appointment_registration'){
            ...
            ->subject('Lawyer Consultation Portal')
        ...
        if($this->notification_setting_name == 'new-signup-law') {
            return (new MailMessage)
            ->subject('Lawyer Consultation Portal')
            ->markdown('emails.general.signup', ['appoint' => $this->data]);
        }
        if($this->notification_setting_name == 'approve_or_reject_lawyer') {
            return (new MailMessage)
            ->subject('Lawyer Consultation Portal')
            ->markdown('emails.general.approve_or_reject', ['lawyer' => $this->data]);
        }
